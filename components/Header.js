...
const NavBar = () => {
  ...
  const links = [
    ...
    { id: 2, name: locale.NAV.LINK, to: '/links', show: true },
    { id: 3, name: locale.NAV.READ, to: '/read', show: true },
    { id: 4, name: locale.NAV.LIFE, to: '/life', show: true },
    { id: 5, name: locale.NAV.HOME, to: '/home', show: true },
    { id: 6, name: locale.NAV.RSS, to: '/feed', show: true, external: true },
    { id: 7, name: locale.NAV.SEARCH, to: '/search', show: true }
  ]
  return (
